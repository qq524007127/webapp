  ...
  <body>
  	...
  	<div id="toolbarPanel">
  		...
  		<span style="padding-left: 25px;">
  			...
  			<input id="grid_searchbox"></input>
			<div id="searchbox_menu" style="width:85px">
			    <div data-options="name:'saler.salerName',iconCls:'icon-user'">经办人</div>
			</div>
